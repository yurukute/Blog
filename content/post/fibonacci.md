...
Đối với n lớn, thay vì cứ nhân cơ số $n$ lần theo định nghĩa, mình số mũlũy thừa đi một nửa. Ví dụ: Thay vì tính $2^6 = 2\times2\times2\times2\times2\times2$, mình sẽ tính $2^6 = 4^4 = 8^2$
